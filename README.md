...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&duration=3000&pause=1000&color=E0527A&center=true&vCenter=true&width=750&lines=Hola%2C+soy+Ana+Ferreira+%F0%9F%91%8B;HR+Ops+%7C+People+Analytics;BI+%26+Data+Analytics;AI+Automation+Specialist;Data+Engineering+in+Training)](https://git.io/typing-svg)
...
![KNIME](https://img.shields.io/badge/KNIME-FDD600?style=flat-square&logo=knime&logoColor=black)
...
- 🏆 **Team Lead — Data Analytics** — Innova Lab, Agencia de Habilidades para el Futuro *(2026)*
- 👥 **Formación en People Analytics** — 11 dominios: Reclutamiento, Rotación, Engagement, Clima, Headcount, Diversidad, ROI de RRHH, Workforce Planning y más
- ⚙️ **Automatización con IA** — Workflows con n8n, Claude API, integración con Slack, Airtable y Google Sheets
- 📊 **BI & Data Analytics** — Power BI, DAX, Looker Studio, modelado dimensional
